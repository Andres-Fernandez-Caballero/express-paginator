...
const IndexController = {
    ...
    index: (req, res) => {
        ...
        const elementos = paginador.obtenerPagina(pagina);
        const paginaActual = pagina;
        const paginaAnterior = paginador.obtenerPaginaAnterior(pagina);
        const paginaSiguiente = paginador.obtenerPaginaSiguiente(pagina);
